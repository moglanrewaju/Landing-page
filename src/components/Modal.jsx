          ...
          <main className="p-4">
            <form action="">
              ...
              <input
                type="text"
                placeholder="Company"
                className="w-full h-11 rounded-sm pl-3 text-sm border mt-2"
              />

              <button className="px-4 py-3 bg-indigo-500 hover:bg-indigo-600 transform transition hover:-translate-y-1 text-white rounded-sm shadow-md mt-10">
                Submit
              </button>
            </form>
          </main>
